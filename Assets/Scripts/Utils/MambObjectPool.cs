...
public class MambObjectPool {
	...
	public MambObjectPool (GameObject objTemplate, int poolSize = 50, Transform poolParent = null, InitObject initMethod = null) {
